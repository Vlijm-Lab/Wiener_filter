...
def wiener_filter(folder):
    ...
    interact(wiener_apply,
             ...
             pixel_size=BoundedIntText(description='Pixel size (nm): ',
                                       min=1,
                                       max=50,
                                       step=1,
             ...
             sigma_confocal=BoundedFloatText(description='FWHM Confocal PSF (nm): ',
                                             min=180,
                                             max=500,
                                             step=1,
                                             value=350, style=style, layout=layout),
             sigma_sted=BoundedFloatText(description='FWHM STED PSF (nm): ',
                                         min=10,
                                         max=120,
                                         step=1,
